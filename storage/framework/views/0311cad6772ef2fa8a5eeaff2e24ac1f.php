...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - <?php if(isset($settings['general']['site_name'])): ?>
            <?php echo e($settings['general']['site_name']); ?>

        <?php endif; ?> <?php echo e(__('static.admin_panel')); ?></title>
...
<?php /**PATH /Users/haykshahinyan/Projects/Direlli/Full/fixit_laravel/resources/views/backend/layouts/master.blade.php ENDPATH**/ ?>