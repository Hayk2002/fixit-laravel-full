...
<div class="action-div">
    ...
    <?php if(isset($serviceRequest)): ?>
        ...
        <a href="javascript:void(0)" class="booking-icon show-icon" data-bs-toggle="modal"
            data-bs-target="#bidsModal<?php echo e($serviceRequest->id); ?>" data-bs-toggle="tooltip" data-placement="bottom" title="Details">
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                ?>
                                <?php $__empty_1 = true; $__currentLoopData = $serviceRequest->bids; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php if(!$isProvider || $bid->provider_id == $currentUserId): ?>
                                        <tr>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <?php if(isset($data->admin_message)): ?>
                                            <tr>
                                                <td>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if(!$data->is_used || (!@$data->is_used_by_admin && Helpers::getCurrentRoleName() != RoleEnum::PROVIDER)): ?>
    ...
    <a href="javascript:void(0)" class="wallet-icon" data-bs-toggle="modal"
        data-bs-target="#walletmodal<?php echo e($data->id); ?>" data-bs-toggle="tooltip" data-placement="bottom" title="Wallet">
                    ...
                    <div class="modal-body text-start">
                        <div class="d-flex align-items-center gap-2 mb-3">
                            ...
                            <div class="form-group row amount wallet">
                                <h5 for="wallet">
                                    <?php echo e(__('static.wallet.balance')); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <a href="javascript:void(0)" class="wallet-icon" data-bs-toggle="modal"
        data-bs-target="#walletmodal<?php echo e($data->id); ?>">
        <i data-feather="credit-card"></i>
    </a>
    <div class="modal fade wallet-modal" id="walletmodal<?php echo e($data->id); ?>" tabindex="-1"
        aria-labelledby="walletmodalLabel<?php echo e($data->id); ?>" aria-hidden="true">
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if(isset($delete)): ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($delete_permission ?? $delete, $data)): ?>
            <?php if(isset($data->system_reserve) ? !$data->system_reserve : true): ?>
                <a href="#confirmationModal<?php echo e($data->id); ?>" data-bs-toggle="modal" class="delete-svg" data-bs-toggle="tooltip" data-placement="bottom" title="Delete">
    ...
    <?php if(isset($status)): ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($status_permission)): ?>
            <?php if(Helpers::getCurrentRoleName() === RoleEnum::ADMIN): ?>
            <div class="dropdown more-option-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusValue => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
    ...
    <?php if(isset($collaps)): ?>
        <?php if(isset($collaps['data'])): ?>
        ...
        <?php endif; ?>
        <?php if(isset($collaps['booking_data'])): ?>
            <div class="d-inline-flex">
                <a href="<?php echo e($collaps['primary_on_click_url']); ?>" class="form-controll">
                    <?php if($collaps['booking_data']->booking_number): ?>
    ...
    <?php if(isset($info)): ?>
        ...
        <?php if(!empty($info->name) && !empty($info->email)): ?>
            <div class="user-info">
...
<?php /**PATH /Users/haykshahinyan/Projects/Direlli/Full/fixit_laravel/resources/views/backend/inc/action.blade.php ENDPATH**/ ?>