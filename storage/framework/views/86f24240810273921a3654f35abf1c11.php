                    ...
                    <div class="main">
                        <form id="loginForm" class="login-form" action="<?php echo e(route('login')); ?>" method='POST'>
                            ...
                            <div class="not-member">
                                <h5><?php echo e(__('frontend::auth.not_member')); ?> <a href="<?php echo e(route('become-provider.index')); ?>">Sign up</a></h5>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">
    ...
    var recaptchaKey = "<?php echo e(env('GOOGLE_RECAPTCHA_KEY')); ?>";
...
<?php echo $__env->make('auth.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/haykshahinyan/Projects/Direlli/Full/fixit_laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>