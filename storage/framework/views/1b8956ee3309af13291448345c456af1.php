    ...
    <div class="main-header-left">
        <div class="logo-wrapper">
            <a href="<?php echo e(route('backend.dashboard')); ?>" class="logo-img">
                <img class="blur-up lazyloaded img-fluid" alt="site-logo" src="<?php echo e(asset($settings['general']['light_logo']) ?? asset('admin/images/Logo-Light.png')); ?>">
            </a>
            <a href="<?php echo e(route('backend.dashboard')); ?>" class="favicon-img">
                <img class="blur-up lazyloaded img-fluid" alt="site-logo" src="<?php echo e(asset($settings['general']['favicon']) ?? asset('admin/images/faviconIcon.png')); ?>">
            </a>
        </div>
    </div>
    <div class="sidebar">
        <ul class="sidebar-menu custom-scrollbar" id="sidebar-menu">
            ...
            <li>
                ...
                <a href="<?php echo e(route('backend.dashboard')); ?>"
                    class="sidebar-header <?php echo e(Request::is('backend/dashboard*') ? 'active' : ''); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.user.index', 'backend.serviceman_withdraw_request.index', 'backend.role.index',
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.user.index', 'backend.role.index'])): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/user*') || Request::is('backend/role*') ? 'active' : ''); ?>">
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e(Request::is('backend/user*') || Request::is('backend/role*') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.user.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.user.index')); ?>"
                                        class="<?php echo e(Request::is('backend/user') && !Request::is('backend/user/create') ? 'active' : ''); ?>"><?php echo e(__('static.users.all')); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.role.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.role.index')); ?>"
                                        class="<?php echo e(Request::is('backend/role*') || Request::is('backend/role/create') ? 'active' : ''); ?>"><?php echo e(__('static.role')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.customer.index', 'backend.wallet.index'])): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/customer*') || Request::is('backend/wallet*') ? 'active' : ''); ?>">
                            <img class="inactive-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/users-line.svg')); ?>">
                            <img class="active-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/users-fill.svg')); ?>">
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e(Request::is('backend/customer*') || Request::is('backend/wallet*') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.customer.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.customer.index')); ?>"
                                        class="<?php echo e(Request::is('backend/customer') && !Request::is('backend/customer/create') ? 'active' : ''); ?>"><?php echo e(__('static.customer.all')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.customer.create')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.customer.create')); ?>"
                                        class="<?php echo e(Request::is('backend/customer/create') ? 'active' : ''); ?>"><?php echo e(__('static.customer.create')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.wallet.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.wallet.index')); ?>"
                                        class="<?php echo e(Request::is('backend/wallet*') ? 'active' : ''); ?>"><?php echo e(__('static.wallet.wallet')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.unverified_user.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.unverfied-users.index', ['role' => RoleEnum::CONSUMER])); ?>"
                                        class="<?php echo e(Request::is('backend/unverfied-users*') ? 'active' : ''); ?>"><?php echo e(__('static.unverfied_users.unverfied_consumer')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.commission_history.index', 'backend.provider.index', 'backend.provider_document.index', 'backend.provider_time_slot.index', 'backend.provider_wallet.index', 'backend.withdraw_request.index'])): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e((!Request::is('backend/providerSiteService*') && Request::is('backend/provider*') && !Request::is('backend/provider-report')) || Request::is('backend/commission*') || Request::is('backend/withdraw-request*') ? 'active' : ''); ?>">
                            <img class="inactive-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/users-line.svg')); ?>">
                            <img class="active-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/users-fill.svg')); ?>">
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e((!Request::is('backend/providerSiteService*') && Request::is('backend/provider*') && !Request::is('backend/provider-report')) || Request::is('backend/withdraw-request*') || Request::is('backend/commission*') ? 'menu-open' : ''); ?>">
                ...
                <?php if(auth()->user()->hasRole(RoleEnum::ADMIN) || (auth()->user()->hasRole(RoleEnum::PROVIDER) && auth()->user()->type === 'company')): ?> 
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.serviceman.index', 'backend.serviceman.create',
                                    'backend.serviceman_withdraw_request.index', 'backend.serviceman_wallet.index'])): ?>
                        <li>
                            <i class="ri-pushpin-2-line"></i>
                            <a href="javascript:void(0);"
                                class="sidebar-header <?php echo e(Request::is('backend/serviceman*') ? 'active' : ''); ?>">
                                <img class="inactive-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/users-line.svg')); ?>">
                                <img class="active-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/users-fill.svg')); ?>">
                            ...
                            <ul class="sidebar-submenu <?php echo e(Request::is('backend/serviceman*') ? 'menu-open' : ''); ?>">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.serviceman.index')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.serviceman.index')); ?>"
                                            class=" <?php echo e(Request::is('backend/serviceman') ? 'active' : ''); ?>"><?php echo e(__('static.serviceman.all')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.serviceman.create')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.serviceman.create')); ?>"
                                            class=" <?php echo e(Request::is('backend/serviceman/create') ? 'active' : ''); ?>"><?php echo e(__('static.serviceman.create')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.serviceman_wallet.index')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.serviceman-wallet.index')); ?>"
                                            class="<?php echo e(Request::is('backend/serviceman-wallet*') ? 'active' : ''); ?>"><?php echo e(__('static.wallet.wallet')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.unverified_user.index')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.unverfied-users.index', ['role' => RoleEnum::SERVICEMAN])); ?>"
                                            class="<?php echo e(Request::is('backend/unverfied-users*') ? 'active' : ''); ?>"><?php echo e(__('static.unverfied_users.unverfied_serviceman')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.unverified_user.index')): ?>
                <li>
                    <i class="ri-pushpin-2-line"></i>
                    <a href="<?php echo e(route('backend.unverfied-users.index')); ?>"
                        class="sidebar-header <?php echo e(Request::is('backend/unverified-users*') ? 'active' : ''); ?>">
                        <img class="inactive-icon"
                            src="<?php echo e(asset('admin/images/svg/sidebar-icon/unverified-users-line.svg')); ?>">
                        <img class="active-icon"
                            src="<?php echo e(asset('admin/images/svg/sidebar-icon/unverified-users-fill.svg')); ?>">
                        <span><?php echo e(__('static.unverfied_users.unverfied_users')); ?></span>
                    </a>
                </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.zone.index', 'backend.service-package.index', 'backend.service.index',
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.service-package.index', 'backend.service.index', 'backend.service_category.index'])): ?>
                    <li>
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e((Request::is('backend/service*') && !Request::is('backend/serviceman*') && !Request::is('backend/servicemen-review*') && !Request::is('backend/service-requests*')) || Request::is('backend/category*') || Request::is('backend/providerSiteService*') || Request::is('backend/additional-service*') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.service.index')); ?>"
                                        class="<?php echo e(Request::is('backend/service*') && !Request::is('backend/service/create') && !Request::is('backend/serviceman*') && !Request::is('backend/service-package*') && !Request::is('backend/servicemen-review*') && !Request::is('backend/service-requests*') ? 'active' : ''); ?>"><?php echo e(__('static.service.all')); ?></a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service_category.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.category.index')); ?>"
                                        class="<?php echo e(Request::is('backend/category*') ? 'active' : ''); ?>"><?php echo e(__('static.categories.categories')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(isset($settings['activation']['additional_services']) && $settings['activation']['additional_services']): ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service.index')): ?>
                                    <li>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service-package.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.service-package.index')); ?>"
                                        class="<?php echo e(Request::is('backend/service-package*') ? 'active' : ''); ?>"><?php echo e(__('static.service_package.service_packages')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service_request.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.service-requests.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/service-requests*') ? 'active' : ''); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.testimonial.index', 'backend.booking.index', 'backend.payment_method.index',
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.booking.index')): ?>
                            <li>
                                <a href="<?php echo e(route('backend.booking.index')); ?>"
                                    class="<?php echo e(Request::fullUrlIs(route('backend.booking.index')) ? 'active' : ''); ?>">
                            ...
                            <li>
                                <a href="<?php echo e(route('backend.booking.index', ['status' => BookingEnumSlug::PENDING])); ?>"
                                    class="<?php echo e(request('status') === BookingEnumSlug::PENDING ? 'active' : ''); ?>">
                                    <?php echo e(__('static.booking.pending')); ?>

                                </a>
                                <span class="badge"><?php echo e(Helpers::getBookingsCountByStatus(BookingEnumSlug::PENDING)); ?></span>
                            </li>
                            <li>
                                <a href="<?php echo e(route('backend.booking.index', ['status' => BookingEnumSlug::ACCEPTED])); ?>"
                                    class="<?php echo e(request('status') === BookingEnumSlug::ACCEPTED ? 'active' : ''); ?>">
                                    <?php echo e(__('static.booking.accepted')); ?>

                                </a>
                                <span
                                    class="badge"><?php echo e(Helpers::getBookingsCountByStatus(BookingEnumSlug::ACCEPTED)); ?></span>
                            </li>
                            <li>
                                <a href="<?php echo e(route('backend.booking.index', ['status' => BookingEnumSlug::ASSIGNED])); ?>"
                                    class="<?php echo e(request('status') === BookingEnumSlug::ASSIGNED ? 'active' : ''); ?>">
                                    <?php echo e(__('static.booking.assigned')); ?>

                                </a>
                                <span
                                    class="badge"><?php echo e(Helpers::getBookingsCountByStatus(BookingEnumSlug::ASSIGNED)); ?></span>
                            </li>
                            <li>
                                <a href="<?php echo e(route('backend.booking.index', ['status' => BookingEnumSlug::ON_THE_WAY])); ?>"
                                    class="<?php echo e(request('status') === BookingEnumSlug::ON_THE_WAY ? 'active' : ''); ?>">
                                    <?php echo e(__('static.booking.on_the_way')); ?>

                                </a>
                                <span
                                    class="badge"><?php echo e(Helpers::getBookingsCountByStatus(BookingEnumSlug::ON_THE_WAY)); ?></span>
                            </li>
                            <li>
                                <a href="<?php echo e(route('backend.booking.index', ['status' => BookingEnumSlug::ON_GOING])); ?>"
                                    class="<?php echo e(request('status') === BookingEnumSlug::ON_GOING ? 'active' : ''); ?>">
                                    <?php echo e(__('static.booking.on_going')); ?>

                                </a>
                                <span
                                    class="badge"><?php echo e(Helpers::getBookingsCountByStatus(BookingEnumSlug::ON_GOING)); ?></span>
                            </li>
                            <li>
                                <a href="<?php echo e(route('backend.booking.index', ['status' => BookingEnumSlug::CANCEL])); ?>"
                                    class="<?php echo e(request('status') === BookingEnumSlug::CANCEL ? 'active' : ''); ?>">
                                    <?php echo e(__('static.booking.cancel')); ?>

                                </a>
                                <span class="badge"><?php echo e(Helpers::getBookingsCountByStatus(BookingEnumSlug::CANCEL)); ?></span>
                            </li>
                            <li>
                                <a href="<?php echo e(route('backend.booking.index', ['status' => BookingEnumSlug::COMPLETED])); ?>"
                                    class="<?php echo e(request('status') === BookingEnumSlug::COMPLETED ? 'active' : ''); ?>">
                                    <?php echo e(__('static.booking.completed')); ?>

                                </a>
                                <span
                                    class="badge"><?php echo e(Helpers::getBookingsCountByStatus(BookingEnumSlug::COMPLETED)); ?></span>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.payment_method.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.transaction.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/transaction*') && !Request::is('backend/transaction-report') ? 'active' : ''); ?>">
                            <img class="inactive-icon"
                                src="<?php echo e(asset('admin/images/svg/sidebar-icon/transactions-line.svg')); ?>">
                            <img class="active-icon"
                                src="<?php echo e(asset('admin/images/svg/sidebar-icon/transactions-fill.svg')); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.review.index')): ?>
                    <li>
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e(Request::is('backend/review*') || Request::is('backend/servicemen-review*') ? 'menu-open' : ''); ?>">
                            <li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.coupon.index', 'backend.plan.index', 'backend.banner.index'])): ?>
                <li class="sidebar-main-title">
                    <div>
                        <h6><?php echo e(__('static.dashboard.marketing_advertising')); ?></h6>
                    </div>
                </li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.coupon.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.coupon.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/coupon*') ? 'active' : ''); ?>">
                ...
                <?php endif; ?>
                <?php if(Helpers::isModuleEnable('Subscription')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.plan.index')): ?>
                        <li>
                            ...
                            <ul
                                class="sidebar-submenu <?php echo e(Request::is('backend/plan*') || Request::is('backend/subscriptions*') ? 'menu-open' : ''); ?>">
                                <li>
                                    <a href="<?php echo e(route('backend.plan.index')); ?>"
                                        class="<?php echo e(Request::is('backend/plan*') ? 'active' : ''); ?>"><?php echo e(__('static.plan.all')); ?></a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('backend.subscription.index')); ?>"
                                        class="<?php echo e(Request::is('backend/subscriptions*') ? 'active' : ''); ?>"><?php echo e(__('static.plan.subscriptions')); ?></a>
                                </li>
                            </ul>
                        </li>
                    <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.banner.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/banner*') ? 'active' : ''); ?>">
                        ...
                        <ul class="sidebar-submenu <?php echo e(Request::is('backend/banner*') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.banner.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.banner.index')); ?>"
                                        class="<?php echo e(Request::is('backend/banner') && !Request::is('backend/banner/create') ? 'active' : ''); ?>"><?php echo e(__('static.banner.all')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.banner.create')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.banner.create')); ?>"
                                        class="<?php echo e(Request::is('backend/banner/create') ? 'active' : ''); ?>"><?php echo e(__('static.banner.create')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.advertisement.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/advertisement*') ? 'active' : ''); ?>">
                        ...
                        <ul class="sidebar-submenu <?php echo e(Request::is('backend/advertisement*') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.advertisement.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.advertisement.index')); ?>"
                                        class="<?php echo e(Request::is('backend/advertisement') && !Request::is('backend/advertisement/create') ? 'active' : ''); ?>"><?php echo e(__('static.advertisement.all')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.advertisement.create')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.advertisement.create')); ?>"
                                        class="<?php echo e(Request::is('backend/advertisement/create') ? 'active' : ''); ?>"><?php echo e(__('static.advertisement.create')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.push_notification.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/notifications*') || Request::is('backend/push-notifications') ? 'active' : ''); ?>">
                            <img class="inactive-icon"
                                src="<?php echo e(asset('admin/images/svg/sidebar-icon/notification-line.svg')); ?>">
                            <img class="active-icon"
                                src="<?php echo e(asset('admin/images/svg/sidebar-icon/notification-fill.svg')); ?>">
                            <span><?php echo e(__('static.notification.notifications')); ?></span>
                            <img class="stroke-icon" src="<?php echo e(asset('admin/images/svg/arrow-right-2.svg')); ?>">
                        </a>
                        <ul
                            class="sidebar-submenu <?php echo e(Request::is('backend/notifications') || Request::is('backend/push-notifications') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.push_notification.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.notifications')); ?>"
                                        class="<?php echo e(Request::is('backend/notifications*') && !Request::is('backend/push-notifications') ? 'active' : ''); ?>"><?php echo e(__('static.notification.list_notifications')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.push_notification.create')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.push-notifications')); ?>"
                                        class="<?php echo e(Request::is('backend/push-notifications') ? 'active' : ''); ?>"><?php echo e(__('static.notification.send')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.news_letter.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.subscribers')); ?>"
                            class="sidebar-header  <?php echo e(Request::is('backend/subscribers') ? 'active' : ''); ?>">
                            <img class="inactive-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/service-line.svg')); ?>">
                            <img class="active-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/service-fill.svg')); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.testimonial.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.testimonial.index')); ?>"
                            class="sidebar-header  <?php echo e(Request::is('backend/testimonial') || Request::is('backend/testimonial/create') ? 'active' : ''); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.tax.index', 'backend.currency.index'])): ?>
                <li class="sidebar-main-title">
                    <div>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.tax.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.tax.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/tax*') ? 'active' : ''); ?>">
                            <img class="inactive-icon"
                                src="<?php echo e(asset('admin/images/svg/sidebar-icon/percentage-line.svg')); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.currency.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.currency.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/currency*') ? 'active' : ''); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.blog_category.index', 'backend.tag.index', 'backend.blog.index', 'backend.page.index'])): ?>
                ...
                <?php if(isset($settings['activation']['blogs_enable']) && $settings['activation']['blogs_enable']): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.blog_category.index', 'backend.tag.index', 'backend.blog.index'])): ?>
                        <li>
                            <i class="ri-pushpin-2-line"></i>
                            <a href="javascript:void(0);"
                                class="sidebar-header <?php echo e(Request::is('backend/tag*') || Request::is('backend/blog*') || Request::is('backend/blog-category*') ? 'active' : ''); ?>">
                                <img class="inactive-icon"
                                    src="<?php echo e(asset('admin/images/svg/sidebar-icon/coupon-line.svg')); ?>">
                                <img class="active-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/coupon-fill.svg')); ?>">
                                <span><?php echo e(__('static.blog.blogs')); ?></span>
                                <img class="stroke-icon" src="<?php echo e(asset('admin/images/svg/arrow-right-2.svg')); ?>">
                            </a>
                            <ul
                                class="sidebar-submenu <?php echo e(Request::is('backend/blog*') || Request::is('backend/tag*') ? 'menu-open' : ''); ?>">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.blog.index')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.blog.index')); ?>"
                                            class="<?php echo e(Request::is('backend/blog') ? 'active' : ''); ?>"><?php echo e(__('static.blog.all')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.blog.create')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.blog.create')); ?>"
                                            class="<?php echo e(Request::is('backend/blog/create') ? 'active' : ''); ?>"><?php echo e(__('static.blog.create')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.blog_category.index')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.blog-category.index')); ?>"
                                            class="<?php echo e(Request::is('backend/blog-category*') ? 'active' : ''); ?>"><?php echo e(__('static.categories.categories')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.tag.index')): ?>
                                    <li>
                                        <a href="<?php echo e(route('backend.tag.index')); ?>"
                                            class="<?php echo e(Request::is('backend/tag*') ? 'active' : ''); ?>"><?php echo e(__('static.tag.tags')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.page.index')): ?>
                    <li>
                        ...
                        <a href="<?php echo e(route('backend.page.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/page*') ? 'active' : ''); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.document.index', 'backend.language.index', 'backend.payment_method.index',
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.document.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/document*') ? 'active' : ''); ?>">
                        ...
                        <ul class="sidebar-submenu <?php echo e(Request::is('backend/document*') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.document.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.document.index')); ?>"
                                        class="<?php echo e(Request::is('backend/document*') && !Request::is('backend/document/create') ? 'active' : ''); ?>"><?php echo e(__('static.document.all')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.document.create')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.document.create')); ?>"
                                        class="<?php echo e(Request::is('backend/document/create') ? 'active' : ''); ?>"><?php echo e(__('static.document.create')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.theme_option.index', 'backend.home_page.index', 'backend.customization.index'])): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/home-page*') || Request::is('backend/theme-option*') || Request::is('backend/customization*') || Request::is('backend/robot*') ? 'active' : ''); ?>">
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e(Request::is('backend/home-page*') || Request::is('backend/theme-options*') || Request::is('backend/customization*') || Request::is('backend/robot*') ? 'menu-open' : ''); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.language.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.systemLang.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/systemLang*') ? 'active' : ''); ?>">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.email_template.index', 'backend.sms_template.index',
                    ...
                    <li>
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e(Request::is('backend/email-template') || Request::is('backend/sms-template') || Request::is('backend/push-notification-template') ? 'menu-open' : ''); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.payment_method.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.paymentmethods.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/payment-methods*') ? 'active' : ''); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.sms_gateway.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.smsgateways.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/sms-gateways*') ? 'active' : ''); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.custom_sms_gateway.index')): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="<?php echo e(route('backend.custom-sms-gateway.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/custom-sms-gateway*') ? 'active' : ''); ?>">
                            <img class="inactive-icon"
                                src="<?php echo e(asset('admin/images/svg/sidebar-icon/sms-gateways-line.svg')); ?>">
                            <img class="active-icon"
                                src="<?php echo e(asset('admin/images/svg/sidebar-icon/sms-gateways-fill.svg')); ?>">
                            <span><?php echo e(__('static.custom_sms_gateways.custom_sms_gateways')); ?></span>
                        </a>
                    </li>
                <?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['backend.backup.index', 'backend.system_tool.index'])): ?>
                    <li>
                        <i class="ri-pushpin-2-line"></i>
                        <a href="javascript:void(0);"
                            class="sidebar-header <?php echo e(Request::is('backend/backup') || Request::is('backend/activity-logs') || Request::is('backend/cleanup-db') || Request::is('backend.import*') ? 'active' : ''); ?>">
                            <img class="inactive-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/file-line.svg')); ?>">
                            <img class="active-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/file-fill.svg')); ?>">
                        ...
                        <ul
                            class="sidebar-submenu <?php echo e(Request::is('backend/backup*') || Request::is('backend/activity-logs*') || Request::is('backend/cleanup-db*') || Request::is('backend/import*') ? 'menu-open' : ''); ?>">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.backup.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.backup.index')); ?>"
                                        class="<?php echo e(Request::is('backend/backup*') ? 'active' : ''); ?>"><?php echo e(__('static.system_tools.backup')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.system_tool.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.activity-logs.index')); ?>"
                                        class="<?php echo e(Request::is('backend/activity-logs*') ? 'active' : ''); ?>"><?php echo e(__('static.system_tools.activity_logs')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.system_tool.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.cleanup-db.index')); ?>"
                                        class="<?php echo e(Request::is('backend/cleanup-db*') ? 'active' : ''); ?>"><?php echo e(__('static.system_tools.database_cleanup')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.system_tool.index')): ?>
                                <li>
                                    <a href="<?php echo e(route('backend.import.index')); ?>"
                                        class="<?php echo e(Request::is('backend/import*') ? 'active' : ''); ?>"><?php echo e(__('static.system_tools.import_export')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.setting.index')): ?>
                    <li>
                        ...
                        <a href="<?php echo e(route('backend.settings.index')); ?>"
                            class="sidebar-header <?php echo e(Request::is('backend/settings*') ? 'active' : ''); ?>">
                            <img class="inactive-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/service-line.svg')); ?>">
                            <img class="active-icon" src="<?php echo e(asset('admin/images/svg/sidebar-icon/service-fill.svg')); ?>">
                ...
                <li class="w-100">
                    <div class="theme-option-box">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <a href="<?php echo e(route('frontend.home')); ?>" class="log-out-btn btn" target="_blank"
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/haykshahinyan/Projects/Direlli/Full/fixit_laravel/resources/views/backend/layouts/partials/sidebar.blade.php ENDPATH**/ ?>