...
<?php $__env->startSection('content'); ?>
    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', ['admin', 'provider', 'serviceman'])): ?>
                        ...
                        <div class="col-xxl-2 col-md-3 col-sm-6">
                            <a href="<?php echo e(route('backend.serviceman.index')); ?>">
                                <div class="total-box color-1">
                                    ...
                                    <?php if(Helpers::getTotalServicemenPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                                        <div class="bottom-box down">
                                            ...
                                            <?php else: ?>
                                                <div class="bottom-box up">
                                                    ...
                                                    <span>
                                    <?php endif; ?>
                                    <?php echo e(Helpers::getTotalServicemenPercentage($start_date, $end_date)['percentage']); ?>% </span>
                                </div>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="col-xxl-2 col-md-3 col-sm-6">
                        <a href="<?php echo e(route('backend.provider.index')); ?>">
                            <div class="total-box color-5">
                                ...
                                <?php if(Helpers::getTotalProvidersPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                                    <div class="bottom-box down">
                                        <svg>
                                        ...
                                        <?php else: ?>
                                            <div class="bottom-box up">
                                                ...
                                                <span>
                                <?php endif; ?>
                                <?php echo e(Helpers::getTotalProvidersPercentage($start_date, $end_date)['percentage']); ?>%</span>
                            </div>
                    </div>
                    </a>
                </div>
                ...
                <div class="col-xxl-2 col-md-3 col-sm-6">
                    <a href="<?php echo e(route('backend.withdraw-request.index')); ?>">
                        <div class="total-box color-3">
                            ...
                            <?php if(Helpers::getProviderWithdrawPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                                <div class="bottom-box down">
                                    <svg>
                                        <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                                    </svg>
                                    ...
                                    <?php else: ?>
                                        <div class="bottom-box up">
                                            ...
                                            <span>
                            <?php endif; ?>
                            <?php echo e(Helpers::getProviderWithdrawPercentage($start_date, $end_date)['percentage']); ?> %</span>
                        </div>
                </div>
                </a>
            </div>
            ...
            <div class="col-xxl-2 col-md-3 col-sm-6">
                <a href="<?php echo e(route('backend.serviceman-withdraw-request.index')); ?>">
                    <div class="total-box color-2">
                        ...
                        <?php if(Helpers::getServicemanWithdrawPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                            <div class="bottom-box down">
                                <svg>
                                    <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                                </svg>
                                ...
                                <?php else: ?>
                                    <div class="bottom-box up">
                                        ...
                                        <span>
                        <?php endif; ?>
                        <?php echo e(Helpers::getServicemanWithdrawPercentage($start_date, $end_date)['percentage']); ?>%</span>
                    </div>
            </div>
            </a>
        </div>
        ...
        <div class="col-xxl-2 col-md-3 col-sm-6">
            <a href="<?php echo e(route('backend.service.index')); ?>">
                <div class="total-box color-3">
                    ...
                    <?php if(Helpers::getTotalServicesPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                        <div class="bottom-box down">
                            <svg>
                                <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                            </svg>
                            ...
                            <?php else: ?>
                                <div class="bottom-box up">
                                    ...
                                    <span>
                    <?php endif; ?>
                    <?php echo e(Helpers::getTotalServicesPercentage($start_date, $end_date)['percentage']); ?>%</span>
                </div>
        </div>
        </a>
        </div>
        ...
        <div class="col-xxl-2 col-md-3 col-sm-6">
            <a href="<?php echo e(route('backend.review.index')); ?>">
                ...
                <div class="total-box color-4">
                    ...
                    <?php if(Helpers::getTotalReviewsPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                        <div class="bottom-box down">
                            <svg>
                                <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                            </svg>
                            ...
                            <?php else: ?>
                                <div class="bottom-box up">
                                    ...
                                    <span>
                    <?php endif; ?>
                    <?php echo e(Helpers::getTotalReviewsPercentage($start_date, $end_date)['percentage']); ?>%</span>
                </div>
        </div>
        </a>
        </div>
    ...
    <div class="col-xxl-2 col-md-3 col-sm-6">
        <a href="<?php echo e(route('backend.commission.index')); ?>">
            ...
            <div class="total-box color-5">
                ...
                <?php if(Helpers::getTotalPaymentPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                    <div class="bottom-box down">
                        <svg>
                            <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                        </svg>
                        ...
                        <?php else: ?>
                            <div class="bottom-box up">
                                ...
                                <span>
                <?php endif; ?>
                <?php echo e(Helpers::getTotalPaymentPercentage($start_date, $end_date)['percentage']); ?>%</span>
            </div>
    </div>
    </a>
    </div>
    <div class="col-xxl-2 col-md-3 col-sm-6">
        <a href="<?php echo e(route('backend.commission.index')); ?>">
            ...
            <div class="total-box color-6">
                ...
                <?php if(Helpers::getTotalPaymentPercentage($start_date, $end_date, 'cash')['status'] == 'decrease'): ?>
                    <div class="bottom-box down">
                        <svg>
                            <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                        </svg>
                        ...
                        <?php else: ?>
                            <div class="bottom-box up">
                                ...
                                <span>
                <?php endif; ?>
                <?php echo e(Helpers::getTotalPaymentPercentage($start_date, $end_date, 'cash')['percentage']); ?>%</span>
            </div>
    </div>
    </a>
    </div>
    ...
    <div class="col-xxl-2 col-md-3 col-sm-6">
        <a href="<?php echo e(route('backend.booking.index')); ?>">
            ...
            <div class="total-box color-7">
                ...
                <?php if(Helpers::getTotalBookingPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                    <div class="bottom-box down">
                        <svg>
                            <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                        </svg>
                        ...
                        <?php else: ?>
                            <div class="bottom-box up">
                                ...
                                <span>
                <?php endif; ?>
                <?php echo e(Helpers::getTotalBookingPercentage($start_date, $end_date)['percentage']); ?>%</span>
            </div>
    </div>
    </a>
    </div>
        ...
        <div class="col-xxl-2 col-md-3 col-sm-6">
            <a href="<?php echo e(route('backend.customer.index')); ?>">
                ...
                <div class="total-box color-1">
                    ...
                    <?php if(Helpers::getTotalCustomersPercentage($start_date, $end_date)['status'] == 'decrease'): ?>
                        <div class="bottom-box down">
                            <svg>
                                <use xlink:href="<?php echo e(asset('admin/images/svg/down-arrow-1.svg#downArrow')); ?>"></use>
                            </svg>
                            ...
                            <?php else: ?>
                                <div class="bottom-box up">
                                    ...
                                    <span>
                    <?php endif; ?>
                    <?php echo e(Helpers::getTotalCustomersPercentage($start_date, $end_date)['percentage']); ?>%</span>
                </div>
        </div>
        </a>
        </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table top-service-table">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $services->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="service-details-box">
                                                        ...
                                                        <?php else: ?>
                                                            <div class="initial-letter">
                                                                <?php echo e(strtoupper(substr($service?->user?->name, 0, 1))); ?></div>
                                                        <?php endif; ?>
                                                        <div class="service-details">
                                                            <h5><?php echo e($service->user?->name); ?></h5>
                                                            <h6><?php echo e($service->user?->email); ?></h6>
                                                        </div>
                                                    </div>
                                                </td>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $Providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($provider?->type); ?></td>

                                                <td><?php echo e($provider?->bookings->count()); ?></td>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table top-providers-table">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $topServicemen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Serviceman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td>
                                                    <div class="service-details-box">
                                                        <?php
                                                ...
                                                <td>
                                                    <?php if(isset($Serviceman->ServicemanReviewRatings)): ?>
                                                        <div class="rate">
                                                            <?php for($i = 0; $i < Helpers::getServicemanReviewRatings($Serviceman); ++$i): ?>
                                                                <img src="<?php echo e(asset('admin/images/svg/star.svg')); ?>"
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table recent-booking-table">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $bookings->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <div class="service-details-box">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="initial-letter">
                                                            <?php echo e(strtoupper(substr($booking?->provider?->name, 0, 1))); ?>

                                                        </div>
                                                    <?php endif; ?>

                                                    <div class="service-details">
                                                        <h5><?php echo e($booking?->provider?->name); ?></h5>
                                                        <h6><?php echo e($booking?->provider?->email); ?></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(count($booking->sub_bookings)): ?>
                                                    <span
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/haykshahinyan/Projects/Direlli/Full/fixit_laravel/resources/views/backend/dashboard/index.blade.php ENDPATH**/ ?>