<script src="<?php echo e(asset('admin/js/password-hide-show.js')); ?>"></script>
<script>
    (function($) {
        "use strict";
        ...
        $(document).on('click', '.close-icon', function(e) {
            ...
            $('#myModal').modal('show');
            let url = "<?php echo e(route('backend.media.delete', '')); ?>" + "/" + id;
...
<?php /**PATH /Users/haykshahinyan/Projects/Direlli/Full/fixit_laravel/resources/views/backend/layouts/partials/script.blade.php ENDPATH**/ ?>